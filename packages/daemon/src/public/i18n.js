...
var I18N_ROWS = [
  ...
  ["memory.tidyHelp", "請模型依 Memory → Plan → Act 整理筆記、標上日期，並提出還缺什麼。不會自動存檔。", "Ask the model to tidy notes (Memory → Plan → Act), date them, and list what's still open. Does not save until you do."],
  ["memory.ask", "需求", "Need"],
