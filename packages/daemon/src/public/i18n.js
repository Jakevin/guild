...
var I18N_ROWS = [
  ...
  ["channels", "委託", "Quests"],
  ["dms", "密談", "Whispers"],
  ["newChannel", "新委託", "New quest"],
  ["newChannelName", "委託名稱", "Quest name"],
  ["create", "建立", "Create"],
  ["delete", "刪除", "Delete"],
  ["deleteFailed", "刪除失敗", "Couldn't delete"],
  ["channel.delete", "刪除委託", "Delete quest"],
  ["channel.deleteConfirm", "刪除 #{name}？紀錄和委託書會一併刪掉。", "Delete #{name}? The log and Quest.md go with it."],
  ["channel.keepGeneral", "#general 不能刪。", "Can't delete #general."],
  ["bot.delete", "請這名隊員離隊", "Drop this party member"],
  ["bot.deleteConfirm", "讓 @{handle} 離隊？密談與記憶會一併刪掉。", "Drop @{handle}? Their whispers and memory go with them."],
  ["members", "小隊", "Party"],
  ["members.in", "在這張委託裡", "On this quest"],
  ["members.out", "不在這張委託", "Not on this quest"],
  ["members.empty", "還沒有隊員。", "Nobody in the party yet."],
  ["members.allIn", "酒館裡的隊員都在這張委託了。", "Everyone from the inn is already on this quest."],
  ["members.kick", "移出", "Remove"],
  ["members.add", "加入", "Add"],
  ["invite.title", "拉隊員進委託", "Add party members"],
  ["invite.body", "勾選要接這張委託的人。委託裡用 @handle 叫他們。", "Pick who takes this quest. @handle them here to get a reply."],
  ["invite.save", "加入", "Add"],
  ...
  ["busy", "忙碌中", "Busy"],
  ["unread", "未讀", "Unread"],
  ["noMessages", "還沒有紀錄。寫一句話開始。委託裡記得 @handle。", "No log yet. Say something. On a quest, @handle a party member."],
  ["dm", "密談", "Whisper"],
  ["justNow", "剛剛", "Just now"],
  ...
  ["channel.md", "委託書", "Quest.md"],
  ["channel.mdHelp", "這張委託的任務說明。用 @handle 叫隊員時會讀到。密談沒有委託書。", "Brief for this quest. Party members see it when you @ them. Whispers have no Quest.md."],
  ["memory.bot", "MEMORY.md", "MEMORY.md"],
  ["memory.botHelp", "這名隊員學會的站立筆記。有用的回合後會自動更新。", "Standing notes this party member has learned. Auto-updated after useful turns."],
  ["memory.channel", "委託 MEMORY.md", "Quest MEMORY.md"],
  ["memory.channelHelp", "這張委託共享的站立筆記。有用的回合後會自動更新。人寫的委託書優先。", "Shared notes for this quest. Auto-updated. The written Quest.md wins if they conflict."],
  ["bot.message", "密談", "Whisper"],
  ["bot.settings", "設定", "Settings"],
  ["notInChannel", "不在這張委託", "Not on this quest"],
  ...
  ["attach.noChannelMd", "這張委託還沒有委託書。請先在委託 icon 寫一份。", "This quest has no Quest.md yet. Write one from the quest icon."],
  ["attach.botRulesTitle", "@{handle} 規則", "@{handle} rules"],
  ["attach.noPersona", "這名隊員還沒有人設。", "This party member has no persona yet."],
  ["slash.editMd", "編輯委託書", "Edit Quest.md"],
  ["slash.editMdHint", "委託說明", "Quest brief"],
  ["slash.rules", "附上規則", "Attach rules"],
  ["slash.rulesHint", "委託書 / 人設", "Quest.md / persona"],
  ["slash.git", "附上 Git", "Attach Git"],
  ["slash.here", "叫全委託", "Ping the quest"],
  ["slash.hereHint", "叫這張委託上的所有隊員", "Ping everyone on the quest"],
  ["slash.library", "開工坊", "Open workshop"],
  ["mention.channel", "@委託", "@quest"],
  ["mention.channelHint", "通知這張委託的所有隊員。", "Notify everyone on this quest."],
  ["mention.here", "@這裡", "@here"],
  ["mention.hereHint", "通知這張委託上的每個隊員。", "Notify every party member here."],
  ["library.eyebrow", "共用工具箱", "Shared toolbox"],
  ["library.title", "技能庫", "Skills"],
  ["library.lede", "公會自己的技能，加上本機 Claude、Codex、Pi、Grok、Cursor 留下的 SKILL.md。安裝走 <a href=\"/skills/add\">追加技能</a>；酒館裡可以直接勾本機 CLI 技能。", "Guild skills plus SKILL.md left on this machine by Claude, Codex, Pi, Grok, and Cursor. Install via <a href=\"/skills/add\">Add skill</a>; staff them from the inn."],
  ["library.install", "安裝新技能", "Install skill"],
  ["library.add", "追加技能", "Add skill"],
  ["library.all", "全部", "All"],
  ["library.host", "本機技能，尚未裝進公會", "On disk, not staffed in the guild"],
  ["library.unused", "還沒有隊員勾選", "No party member selected this yet"],
  ...
  ["mcp.title", "MCP", "MCP"],
  ["mcp.lede", "連接器，不是技能。Skill 是說明書；MCP 是工具伺服器。連上之後，隊員可以直接 call 這些 tools。本機 Codex / Claude / Cursor 的 MCP 會列出來，匯入後才會進公會。", "Connectors, not skills. Skills are instructions; MCP is a tool server. After it is connected, party members can call those tools. Codex / Claude / Cursor MCP configs on this machine show up here; import them into the guild to use them."],
  ...
  ["mcp.guildHint", "已連接。這張委託裡的隊員都能用這些 tools。", "Connected. Party members on a quest can call these tools."],
  ...
  ["settings.localeHint", "寫進這個瀏覽器。大廳、酒吧、工坊、模型共用。", "Saved in this browser. Shared by Hall, Bar, Workshop, and Models."],
  ...
  ["studio.hire", "招募隊員", "Recruit a party member"],
  ...
  ["studio.oneLinerPh", "這名隊員在小隊裡做什麼", "What this party member does in the party"],
  ...
  ["studio.botSkills", "這名隊員的技能（含本機 CLI）", "This party member's skills (including local CLI)"],
  ["studio.botSkillsHint", "公會技能庫，加上本機 Claude、Codex、Pi、Grok、Cursor、DSH 的 SKILL.md。勾或取消會立刻存檔，拷進公會再配給這名隊員。沒有的可到 <a href=\"/skills/add\">追加技能</a> 安裝，不影響其他人。", "The guild library plus SKILL.md on disk from Claude, Codex, Pi, Grok, Cursor, and DSH. Checks save immediately and copy a host skill into the guild for this party member. Missing ones go through <a href=\"/skills/add\">Add skill</a>."],
  ...
  ["studio.editTitle", "改這名隊員的設定", "Edit this party member"],
  ...
  ["studio.editDocTitle", "Guild — 設定隊員", "Guild — Edit party member"],
  ["studio.picked", "這名隊員勾了 {n} 項 · 公會 {guild} · 本機 CLI {host}", "This party member has {n} selected · {guild} guild · {host} local CLI"],
  ...
  ["studio.hireToast", "新隊員。今晚第一杯我請。", "New party member. First round is on me."],
  ["studio.keeper", "掌櫃", "Keep"],
  ["studio.keeperLine", "進來坐。點裡面的人可以密談或改設定。", "Come in. Tap someone to whisper or edit."],
  ["studio.vacant", "空位", "Vacant"],
  ["studio.vacantLine", "空座位。要招隊員進來嗎？", "Empty stool. Recruit someone?"],
  ["studio.hireChip", "招募", "Hire"],
  ["studio.drink", "……今晚在這兒喝酒。", "…drinking here tonight."],
  ["studio.notFound", "找不到這名隊員", "Party member not found"],
  ["studio.editing", "正在編輯 @{handle} · 勾選只屬於這名隊員", "Editing @{handle} · skills are only for this party member"],
  ["skillsAdd.eyebrow", "Skills", "Skills"],
  ["skillsAdd.title", "追加技能", "Add skill"],
  ["skillsAdd.lede", "這裡才是安裝入口。裝進技能庫之後，再到酒館點每名隊員，各自勾選要用的技能。", "This is the install door. After it is in the library, staff each party member from the inn."],
  ...
  ["skillsAdd.recentHint", "完整清單在 <a href=\"/library\">技能庫</a>。要讓隊員帶上，到 <a href=\"/studio\">酒館</a> 點那個人勾選。", "Full list is in <a href=\"/library\">Skills</a>. Staff a party member from the <a href=\"/studio\">inn</a>."],
