...
var I18N_ROWS = [
  ...
  ["send", "送出", "Send"],
  ["stop", "停止", "Stop"],
  ["steer.hint", "Enter 排隊 · {mod}↩ 插入引導", "Enter to queue · {mod}↩ to steer"],
  ...
  ["slash.library", "開技能庫", "Open skills"],
  ...
  ["settings.localeHint", "寫進這個瀏覽器。訊息、酒吧、技能庫、模型共用。", "Saved in this browser. Shared by Chat, Bar, Skills, and Models."],
